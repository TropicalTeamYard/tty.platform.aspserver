...
{
    /// <summary>
    /// 指示<see cref="USettings"/>操作对象的转换类别.
    /// </summary>
            ...
            foreach (var propertyInfo in GetType().GetProperties())
            {
                if (propertyInfo.GetCustomAttribute(typeof(XmlIgnoreAttribute)) == null && propertyInfo.CanWrite && propertyInfo.CanRead)
                {
                    try
                    {
                        ...
                        Type contentType = Extensions.GetAssemblyQualifiedType(element.Attribute("type").Value);
        ...
        internal static dynamic ToObject(XElement element, Type type)
        {
            ...
            else
            {
                ...
                foreach (var propertyInfo in type.GetProperties())
                {
                    ...
                    Type contentType = Extensions.GetAssemblyQualifiedType(e.Attribute("type").Value);
